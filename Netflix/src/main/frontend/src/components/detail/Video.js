    ...
    <div>
      <div className="watch-video" data-uia="watch-video">
        <div className="watch-video--player-view" data-uia="watch-video-player-view-minimized">
          <div className="passive ltr-fntwn3" data-uia="player" data-videoid="81566007" tabindex="0">
            <div className="ltr-op8orf" data-uia="video-canvas">
              <div style="position: relative; width: 100%; height: 100%; overflow: hidden;">
                <div className='relative w-[100%] h-[100%] overflow-hidden' id="81566007">
                  ...
                  <div className="player-timedtext hidden" style="display: none; direction: ltr;"></div>
                </div>
              </div>
            </div>
            <div className="ltr-1420x7p" style="align-items: normal; justify-content: flex-end;">
              <div className="ltr-hpbgml" style="align-items: flex-start; flex-grow: 1; justify-content: flex-start;">
                <div className="ltr-1i33xgl" style="align-items: normal; justify-content: normal;">
                  <div className="watch-video--back-container ltr-hpbgml" style="align-items: normal; flex-grow: 1; justify-content: flex-start;">
                  ...
                  <div className="watch-video--flag-container ltr-hpbgml" style="align-items: normal; flex-grow: 1; justify-content: flex-end;">
                    <div className="medium ltr-1dcjcj4">
              ...
              <div className="watch-video--skip-content ltr-hpbgml" style="align-items: center; justify-content: flex-end;">
              ...
              <div className="watch-video--bottom-controls-container ltr-hpbgml" style="align-items: flex-end; justify-content: center;">
                  <div className="ltr-jezwko" data-uia="controls-standard" tabindex="0">
                      <div className="ltr-1bt0omd">
                          <div className="ltr-1i33xgl" style="align-items: normal; justify-content: normal;">
                              <div className="ltr-hpbgml" style="align-items: center; flex-grow: 1; justify-content: normal;">
                                  <div aria-orientation="horizontal" className="medium ltr-13q34j2" data-uia="timeline" max="4626663" min="0" role="slider" tabindex="-1">
                                      <div data-uia="timeline-bar" className="ltr-lbmpgb">
                                          <div className="ltr-xd82k2" style="width: 42.2681px;"></div>
                                          <div className="ltr-1c4ubff" style="width: 8.32163px;"></div>
                                          <div
                                              ...
                                              style="left: calc(8.32163px - 0.75rem);"
                                          ></div>
                                      </div>
                                  </div>
                              </div>
                              <div className="ltr-6alejv" style="align-items: center; justify-content: center;"><span className="ltr-jgzoky" data-uia="controls-time-remaining">1:16:32</span></div>
                          </div>
                          <div className="ltr-1i33xgl" style="height: 3rem; min-height: 3rem; min-width: 100%; width: 100%;"></div>
                          <div className="ltr-1bt0omd">
                              <div className="ltr-1i33xgl" style="align-items: normal; justify-content: normal;">
                                  <div className="ltr-hpbgml" style="align-items: normal; justify-content: normal;">
                                      <div className="medium ltr-1dcjcj4">
                                      ...
                                      <div className="ltr-1i33xgl" style="min-width: 3rem; width: 3rem;"></div>
                                      <div className="medium ltr-1dcjcj4">
                                  ...
                                  <div className="ltr-1fkysoc" style="align-items: normal; flex-grow: 1; justify-content: normal;">
                                      <div className="ltr-1i33xgl" style="min-width: 3rem; width: 3rem;"></div>
                                      <div className="medium ltr-qnht66" data-uia="video-title">
                                          <h4>이상한 변호사 우영우</h4>
                                          <span>1화</span><span>이상한 변호사 우영우</span>
                                      </div>
                                  </div>
                                  <div className="ltr-hpbgml" style="align-items: normal; justify-content: flex-end;">
                                      <div className="ltr-1i33xgl" style="min-width: 3rem; width: 3rem;"></div>
                                      <div className="medium ltr-1dcjcj4">
