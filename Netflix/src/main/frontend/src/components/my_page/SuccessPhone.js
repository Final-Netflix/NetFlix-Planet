        ...
        <div className = "m2_container">
                <div className="px-32 py-36 w-full min-h-[1000px] max-w-[1248px] mx-auto">
                    ...
                    <div className = "flex w-[100%] pt-7 pb-4 pl-5 rounded-md bg-green-500 z-0">
                        ...
                        <div className = " w-[100%] pt-1 text-xl">프로필 전화번호가 변경되었습니다.</div>
                    </div>
                    <div className="w-full pb-20">
                        <div className="border-solid mt-9 border-t-[1px] h-9 border-zinc-700 w-full">
                            <div className="flex justify-start w-full">
                                ...
                                <div className='w-full mb-7'>
                                    <div className="flex justify-between w-full">
                                        ...
                                        <button>
                                            <Link to='/my/mfa' onClick={valEmail}><div className="pt-6 pl-90 text-end text-blue-500">이메일 변경</div></Link>
                                        </button>
                                    </div>
                                    <div className="flex justify-between">
                                        <div className="pt-5 text-neutral-500">비밀번호 : ****************</div>
                                        <button>
                                            <Link to='/my/changePwd'><div className="pl-90 pt-5 text-end text-blue-500">비밀번호 변경</div></Link>
                                        </button>
                                    </div>
                                    <div className="flex justify-between">
                                        <div className="pt-5 text-neutral-500">전화번호 : {phone(user_phone)}</div>
                                        <button>
                                            <Link to='/my/mfa' onClick={valPhone}><div className="pl-90 pt-5 text-end text-blue-500">휴대폰 번호 변경</div></Link>
                                        </button>
                                    </div>
                            ...
                            <div className="flex justify-start w-full mb-2">
                                ...
                                <button>
                                    <Link to='/my/changePlan'><div className="ml-[540px] text-blue-500">멤버십 변경</div></Link>
                                </button>
