        ...
        <div>
            ...
            <div className = "m-[20px] p-0 block w-full min-h-[1000px] max-w-[1248px] mx-auto min-w-[740px]">
                <div className = "px-[5%] min-h-[400px] min-w-[400px] m-auto block relative w-[100%]">
                        ...
                        <li>
                            <div className = "flex justify-start w-full relative">
                                <div className = "flex pl-3">
                                    <div className = "mt-3 text-lg">22.8.2</div>
                                    <a className = "mt-3 ml-20 text-lg w-[860px] text-[#0080ff]">슬기로운 의사생활 : 시즌 1 : "1화"</a>
                                </div>
                                <div className = "relative justify-end">
                                    <button className = " relative mt-3 text-lg">버그/문제신고</button>
                    ...
                    <div className="border-solid mt-[17px] border-t-[1px] h-1 border-neutral-300 w-[100%]"></div>
                        <div className = "flex">
                            <button className = "rounded w-[110px]  bg-[#0080ff] text-[#fff] h-[43px]  text-lg mt-10  "  >더 보기</button>
                            <button className = "rounded w-[220px]  bg-[#ccc] text-[#000] h-[43px]  text-lg mt-10 ml-3  ">계정 페이지로 돌아가기</button>
                            <div className = "flex relative text-lg ml-[50%] mt-12">
