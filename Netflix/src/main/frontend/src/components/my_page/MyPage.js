...
const MyPage = () => {
    ...
    return (
        <div className=" m2_screen w-screen min-h-screen relative">
            <MyPageHeader/>
            <div className = "m2_container">
                <div className="px-32 py-36 w-full h-full max-w-[1248px] mx-auto">
                            ...
                            <div className="flex justify-start w-full">
                                ...
                                <div className='w-full'>
                                    <div className="flex justify-between w-full">
                                        ...
                                        <button>
                                            <div className="pt-6 pl-90 text-end text-blue-500">계정 이메일 변경</div>
                                        </button>
                                    </div>
                                    <div className="flex justify-between">
                                        <div className="pt-5 text-neutral-500">비밀번호 : ****************</div>
                                        <button>
                                            <div className="pl-90 pt-5 text-end text-blue-500">계정 비밀번호 바꿈</div>
                                        </button>
                                    </div>
                                    <div className="flex justify-between">
                                        <div className="pt-5 text-neutral-500">전화번호 : 010-1234-5678</div>
                                        <button>
                                            <div className="pl-90 pt-5 text-end text-blue-500">전화번호 바꾸기</div>
                                        </button>
                                    </div>
                                ...
                                <div className=" text-zinc-500 text-xl pb-5  w-[270px] ">프로필 & 자녀 보호 설정</div>
                                    <div className = "w-[80%] m2_user">
                                        <div className="flex flex-wrap ml-20">
                                            ...
                                            <button className="ml-[72%]" onClick = { onToggle1 }>
                                        ...
                                        <div className="flex flex-wrap ml-20 ">
                                            ...
                                            <button className="ml-[72%]" onClick = { onToggle2 }>
                                        ...
                                        <div className="flex flex-wrap ml-20">
                                            ...
                                            <button className="ml-[72%]" onClick = { onToggle3 }>
                                        ...
                                        <ul>
                                            ...
                                            <div className="flex flex-wrap ml-20">
                                                ...
                                                />
                                                <div className="pt-3 pl-5 w-60">
                                                    <h3 className="font-bold pb-2">키즈당</h3>
                                                    <div className="text-gray-600 text-xs">12+ 12+ 등급 이하</div>
                                                </div>
                                                <button className="flex justify-start pt-3 pl-[50%]" onClick={ onToggle4 }>
