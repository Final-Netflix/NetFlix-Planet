                    ...
                    <div className="w-full pb-20">
                        <div className="border-solid mt-9 border-t-[1px] h-9 border-zinc-700 w-full">
                            ...
                            <div className="flex justify-start w-full mb-4">
                                <div className="text-zinc-500 w-[400px] text-xl pb-5 pt-5 z-0">멤버십 & 상세정보</div>
                                <div className='w-full'>
                                    <div className="flex justify-between w-full">
                                        <div className="pt-6 pl-10 font-bold">베이식</div>
                                        <button>
                                            <Link to='mfa'><div className="pt-6 pl-90 text-end text-blue-500">멤버십 변경</div></Link>
                                        </button>
                                    </div>
                                   </div>
                            </div>
