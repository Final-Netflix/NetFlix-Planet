...
import MyPageAddEmail from './MyPageAddEmail';
                ...
                <div className = "m-[20px] p-0 block">
                    <div className = "px-[20%] min-h-[400px] min-w-[300px] m-auto block relative w-[90%]">
                        ...
                        <div className="  text-red-500 mb-4">5에서 50자 내외의 이메일 주소를 입력하세요. (예: name@example.com)</div>
                            ...
                            <button className = "rounded w-[98px]  bg-[#e50914] text-[#fff] h-[37px] font-bold text-lg "  onClick={ onAdd } >저장</button>
                            <button className = "rounded w-[98px] bg-[#ccc] h-[37px] text-inherit font-bold ml-4 text-lg" onClick={ onSub }>취소</button>

                            <div>{ count }</div>
                            {
                                count === 0 && <MyPageAddEmail/>
                            }
                            {
                                count === 1 && <MyPage/>
                            }`
