                    ...
                    <div className = "px-[20%] min-h-[400px] min-w-[300px] m-auto block relative w-[90%]">
                        <form className='w-[200%] text-2xl' method = "post">
                            ...
                            <div className = "mt-4">
                                ...
                                <div className = "mb-2 mt-5">
                                    <input type = "text" onChange = { onChangeEmail } className="w-[400px] h-[40px] border-x-2 border-y-2 border-t-1 border-r-1 border-b-1 border-l-1 text-sm border-green-600"  maxLength = "50" minLength = "5" placeholder = "이메일주소"></input>
                                </div>
                            </div>
                        { isChk ? <div className=" text-red-500 mb-4" >5에서 50자 내외의 이메일 주소를 입력하세요. (예: name@example.com)</div> : ''}
                            <div className = "mb-5 text-lg">
                                ...
                                <button type = "button" className = "rounded w-[10%] bg-[#ccc] h-[37px] text-inherit ml-4 text-lg">이메일 주소 삭제</button>
                                <Link to = "/my">
