        ...
        <div>
            <div className = "m1_bd m-[20px] p-0 block w-full min-h-[1000px] max-w-[1248px] mx-auto min-w-[740px]" style={{margin : 'auto'}}>
                <div className = "px-[5%] min-h-[400px] min-w-[400px] m-auto block relative w-[100%]">
                            ...
                            <li>
                                <div className = "flex justify-start w-full relative">
                                    <div className = "flex pl-3">
                                        <div className = "text-xl">22.8.2</div>
                                        <a className = "ml-20 text-xl w-[860px] text-[#0080ff]">슬기로운 의사생활 : 시즌 1 : "1화"</a>
                                    </div>
                    ...
                    <div className="border-solid my-[10px] border-t-[1px] h-1 border-neutral-300 w-[100%]"></div>
                    <ul>
                        <li>
                            <div className = "flex">
                                <div className = "flex pl-3">
